...
form.addEventListener('submit', e => {
  ...
  .then(data => {
    if (data.results === 0) {
      ...
      const temperatureFahrenheit = temperatureMatch ? temperatureToFahrenheit(temperatureMatch[1]) : '';
      ...
      weather.innerHTML = `Temperature: ${temperatureCelsius}°C / ${temperatureFahrenheit}°F<br>Wind Direction: ${windDirection}<br>Wind Speed: ${windSpeedKnots} knots / ${windSpeedMph} mph / ${windSpeedKph} km/h<br>Barometer: ${barometer} hPA`;
    }
  })
  .catch(error => {
